...
<div class="form-field">
	...
	<input type="text" id="pb_price_table-<?php echo esc_attr($values['widget_index']); ?>-th_color" name="pagebuilder[widget][<?php echo esc_attr($values['widget_index']); ?>][th_color]" value="<?php echo esc_attr($values['th_color']); ?>" class="pb-wp-color-picker" data-default-color="<?php echo esc_attr($default_values['th_color']); ?>" />
</div>

<div class="form-field">
	<h4><?php _e('Background color for headline', 'tcd-w'); ?></h4>
	<input type="text" id="pb_price_table-<?php echo esc_attr($values['widget_index']); ?>-th_background_color" name="pagebuilder[widget][<?php echo esc_attr($values['widget_index']); ?>][th_background_color]" value="<?php echo esc_attr($values['th_background_color']); ?>"  class="pb-wp-color-picker" data-default-color="<?php echo esc_attr($default_values['th_background_color']); ?>" />
</div>
