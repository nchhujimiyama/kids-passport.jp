...
<div class="form-field form-field-map_address">
	...
	<input class="large-text" type="text" name="pagebuilder[widget][<?php echo esc_attr($values['widget_index']); ?>][map_address]" value="<?php echo esc_attr( $values['map_address'] ); ?>">
</div>
