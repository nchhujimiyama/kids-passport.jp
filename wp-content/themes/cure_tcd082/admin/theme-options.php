...
/**
 * cure オプションTools デフォルト画像設定フィルター
 */
function cure_theme_options_tools_get_default_images_settings( $default_images_settings ) {
	// デフォルト画像設定
	return array(
/*
		array(
...
*/
		...
		array(
			'media_filename' => 'image_500x200.gif',
			'source_filepath' => get_template_directory() . '/admin/img/default/image_500x200.gif',
		...
		array(
			...
			'theme_option_keys' => array( "['contents_builder'][2]['image']" )
		),
		array(
			'media_filename' => 'image_1200x400.gif',
			'source_filepath' => get_template_directory() . '/admin/img/default/image_1200x400.gif',
			'theme_option_keys' => array( 'blog_bg_image', 'news_bg_image', 'service_bg_image', 'faq_bg_image' )
		),
		array(
		...
		array(
			...
			'theme_option_keys' => array( 'footer_banner_image1', 'footer_banner_image2', 'footer_banner_image3', 'footer_banner_image4' )
		),
	);
}
...
/**
 * cure オプションTools サンプルカテゴリー
 */
function cure_theme_options_tools_set_sample_categories( $dp_options ) {
...
/**
 * cure オプションTools サンプル記事 ---------------------------------------------------------------------------
 */
function cure_theme_options_tools_set_sample_posts( $dp_options ) {
	...
	// サービスのカスタムフィールド用画像
	$service_custom_media_id = (int) theme_options_tools_get_media_id( array(
		'media_filename' => 'image_240x100.gif',
		'source_filepath' => get_template_directory() . '/admin/img/default/image_240x100.gif'
	), true );
	$service_custom_media_id2 = (int) theme_options_tools_get_media_id( array(
		'media_filename' => 'image_100x100.gif',
		'source_filepath' => get_template_directory() . '/admin/img/default/image_100x100.gif'
	), true );
	...
	for ( $i = 1; $i <= 4; $i++ ) {
		$sample_posts[] = array(
			'post_title' => __( 'Sample service', 'tcd-w' ) . $i,
			'post_content' => __( 'Sample text. Sample text.', 'tcd-w' ),
			...
			'metas' => array(
				'index_image' => $service_custom_media_id,
				'mega_image' => $service_custom_media_id2,
				'desc1' => __( 'Description will be displayed here.<br />Description will be displayed here.', 'tcd-w' ),
				'desc2' => __( 'Description will be displayed here.<br />Description will be displayed here.', 'tcd-w' ),
			)
...
/**
 * cure オプションTools サンプルメニュー ------------------------------------------------------------------
 */
function cure_theme_options_tools_set_sample_menus( $dp_options ) {
...
/**
 * cure オプションTools サンプルウィジェット（ブログページ左） -----------------------------------------------------------------
 */
function cure_theme_options_tools_set_sample_widgets( $dp_options ) {
 ...
 * cure テーマ初期化フィルター ----------------------------------------------------------------------------
 */
add_filter( 'tcd_theme_options_tools-get_default_images_settings', 'cure_theme_options_tools_get_default_images_settings', 10, 1 );
add_filter( 'tcd_theme_options_tools-initialize', 'cure_theme_options_tools_set_sample_categories', 10, 1 );
add_filter( 'tcd_theme_options_tools-initialize', 'cure_theme_options_tools_set_sample_posts', 10, 1 );
add_filter( 'tcd_theme_options_tools-initialize', 'cure_theme_options_tools_set_sample_menus', 10, 1 );
add_filter( 'tcd_theme_options_tools-initialize', 'cure_theme_options_tools_set_sample_widgets', 10, 1 );
