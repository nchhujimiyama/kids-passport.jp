...
function add_news_dp_default_options( $dp_default_options ) {
	...
	$dp_default_options['show_news_archive_sidebar'] = 1;
	$dp_default_options['show_news_single_sidebar'] = 1;
	...
	$dp_default_options['news_title_direction'] = '';
	$dp_default_options['news_sub_title'] = 'NEWS';
	$dp_default_options['news_sub_title_font_type'] = 'type2';
	$dp_default_options['news_sub_title_font_size'] = '16';
	$dp_default_options['news_sub_title_font_size_mobile'] = '14';
	$dp_default_options['news_sub_title_font_color'] = '#FFFFFF';
	$dp_default_options['news_sub_title_bg_color'] = '#00a7ce';
	...
	// アーカイブページ
	$dp_default_options['archive_news_headline'] = '';
	$dp_default_options['archive_news_headline_font_size'] = '14';
	$dp_default_options['archive_news_headline_font_size_mobile'] = '12';
	$dp_default_options['archive_news_headline_font_color'] = '#00a6cc';
	$dp_default_options['archive_news_headline_font_type'] = 'type2';
	$dp_default_options['archive_news_catch'] = '';
	$dp_default_options['archive_news_catch_font_type'] = 'type3';
	$dp_default_options['archive_news_catch_font_size'] = '38';
	$dp_default_options['archive_news_catch_font_size_mobile'] = '20';
	...
	$dp_default_options['archive_news_title_font_size_mobile'] = '15';
	...
	$dp_default_options['show_recent_news_button'] = 1;
	$dp_default_options['recent_news_button_label'] = __( 'News list', 'tcd-w' );
	$dp_default_options['recent_news_button_font_color'] = '#ffffff';
	$dp_default_options['recent_news_button_bg_color'] = '#02a8c6';
	$dp_default_options['recent_news_button_font_color_hover'] = '#ffffff';
	$dp_default_options['recent_news_button_bg_color_hover'] = '#007a96';
	$dp_default_options['recent_news_title_font_size'] = '18';
	$dp_default_options['recent_news_title_font_size_mobile'] = '15';
   ...
   <div class="theme_option_field cf theme_option_field_ac">
    ...
    <div class="theme_option_field_ac_content">
     ...
     <ul class="option_list">
      <li class="cf"><span class="label"><?php _e('Display on archive page', 'tcd-w');  ?></span><input name="dp_options[show_news_archive_sidebar]" type="checkbox" value="1" <?php checked( '1', $options['show_news_archive_sidebar'] ); ?> /></li>
      <li class="cf"><span class="label"><?php _e('Display on single page', 'tcd-w');  ?></span><input name="dp_options[show_news_single_sidebar]" type="checkbox" value="1" <?php checked( '1', $options['show_news_single_sidebar'] ); ?> /></li>
     </ul>
   ...
   <div class="theme_option_field cf theme_option_field_ac">
    ...
    <div class="theme_option_field_ac_content">
     ...
     <ul class="option_list">
      ...
      <li class="cf"><span class="label"><?php _e('Font direction', 'tcd-w'); ?></span><input name="dp_options[news_title_direction]" type="checkbox" value="1" <?php checked( $options['news_title_direction'], 1 ); ?>><?php _e( 'Display vertically', 'tcd-w' ); ?></li>
     </ul>
     ...
     <textarea class="full_width" cols="50" rows="2" name="dp_options[news_sub_title]"><?php echo esc_textarea(  $options['news_sub_title'] ); ?></textarea>
     <ul class="option_list">
      <li class="cf"><span class="label"><?php _e('Font type', 'tcd-w');  ?></span>
       <select name="dp_options[news_sub_title_font_type]">
        <?php foreach ( $font_type_options as $option ) { ?>
        <option style="padding-right: 10px;" value="<?php echo esc_attr($option['value']); ?>" <?php selected( $options['news_sub_title_font_type'], $option['value'] ); ?>><?php echo $option['label']; ?></option>
        <?php } ?>
       </select>
      </li>
      ...
      <li class="cf"><span class="label"><?php _e('Font color', 'tcd-w'); ?></span><input type="text" name="dp_options[news_sub_title_font_color]" value="<?php echo esc_attr( $options['news_sub_title_font_color'] ); ?>" data-default-color="#ffffff" class="c-color-picker"></li>
      <li class="cf"><span class="label"><?php _e('Background color', 'tcd-w'); ?></span><input type="text" name="dp_options[news_sub_title_bg_color]" value="<?php echo esc_attr( $options['news_sub_title_bg_color'] ); ?>" data-default-color="#00a7ce" class="c-color-picker"></li>
     </ul>
   ...
   <div class="theme_option_field cf theme_option_field_ac">
    ...
    <div class="theme_option_field_ac_content">
     ...
     <ul class="option_list">
      ...
      <li class="cf"><span class="label"><?php _e('Font color', 'tcd-w'); ?></span><input type="text" name="dp_options[archive_news_headline_font_color]" value="<?php echo esc_attr( $options['archive_news_headline_font_color'] ); ?>" data-default-color="#00a6cc" class="c-color-picker"></li>
     </ul>
     <h4 class="theme_option_headline2"><?php _e('Catchphrase', 'tcd-w');  ?></h4>
     <textarea class="full_width" cols="50" rows="4" name="dp_options[archive_news_catch]"><?php echo esc_textarea(  $options['archive_news_catch'] ); ?></textarea>
     <ul class="option_list">
      <li class="cf"><span class="label"><?php _e('Font type', 'tcd-w');  ?></span>
       <select name="dp_options[archive_news_catch_font_type]">
        <?php foreach ( $font_type_options as $option ) { ?>
        <option style="padding-right: 10px;" value="<?php echo esc_attr($option['value']); ?>" <?php selected( $options['archive_news_catch_font_type'], $option['value'] ); ?>><?php echo $option['label']; ?></option>
        <?php } ?>
       </select>
      </li>
      <li class="cf"><span class="label"><?php _e('Font size', 'tcd-w'); ?></span><input class="font_size hankaku" type="text" name="dp_options[archive_news_catch_font_size]" value="<?php esc_attr_e( $options['archive_news_catch_font_size'] ); ?>" /><span>px</span></li>
      <li class="cf"><span class="label"><?php _e('Font size (mobile)', 'tcd-w'); ?></span><input class="font_size hankaku" type="text" name="dp_options[archive_news_catch_font_size_mobile]" value="<?php esc_attr_e( $options['archive_news_catch_font_size_mobile'] ); ?>" /><span>px</span></li>
     </ul>
     <h4 class="theme_option_headline2"><?php _e('Description', 'tcd-w');  ?></h4>
     <textarea class="full_width" cols="50" rows="4" name="dp_options[archive_news_desc]"><?php echo esc_textarea(  $options['archive_news_desc'] ); ?></textarea>
     <ul class="option_list">
      <li class="cf"><span class="label"><?php _e('Font size', 'tcd-w'); ?></span><input class="font_size hankaku" type="text" name="dp_options[archive_news_desc_font_size]" value="<?php esc_attr_e( $options['archive_news_desc_font_size'] ); ?>" /><span>px</span></li>
      <li class="cf"><span class="label"><?php _e('Font size (mobile)', 'tcd-w'); ?></span><input class="font_size hankaku" type="text" name="dp_options[archive_news_desc_font_size_mobile]" value="<?php esc_attr_e( $options['archive_news_desc_font_size_mobile'] ); ?>" /><span>px</span></li>
     </ul>
    ...
    <div class="theme_option_field_ac_content">
     ...
     <div style="<?php if($options['show_recent_news'] == 1) { echo 'display:block;'; } else { echo 'display:none;'; }; ?>">
      ...
      <ul class="option_list displayment_checkbox" style="border-top:1px dotted #ccc; padding-top:8px; margin:-12px 0;">
       <li class="cf"><span class="label"><?php _e('Display button for archive page', 'tcd-w');  ?></span><input name="dp_options[show_recent_news_button]" type="checkbox" value="1" <?php checked( '1', $options['show_recent_news_button'] ); ?> /></li>
      </ul>
      <div style="<?php if($options['show_recent_news_button'] == 1) { echo 'display:block;'; } else { echo 'display:none;'; }; ?>">
       <ul class="option_list" style="border-top:1px dotted #ccc; padding-top:12px;">
        <li class="cf"><span class="label"><?php _e('Label of button', 'tcd-w');  ?></span><input class="full_width" type="text" name="dp_options[recent_news_button_label]" value="<?php esc_attr_e( $options['recent_news_button_label'] ); ?>" /></li>
        <li class="cf"><span class="label"><?php _e('Font color of button', 'tcd-w'); ?></span><input type="text" name="dp_options[recent_news_button_font_color]" value="<?php echo esc_attr( $options['recent_news_button_font_color'] ); ?>" data-default-color="#ffffff" class="c-color-picker"></li>
        <li class="cf"><span class="label"><?php _e('Background color of button', 'tcd-w'); ?></span><input type="text" name="dp_options[recent_news_button_bg_color]" value="<?php echo esc_attr( $options['recent_news_button_bg_color'] ); ?>" data-default-color="#02a8c6" class="c-color-picker"></li>
        <li class="cf color_picker_bottom"><span class="label"><?php _e('Font color of button on mouseover', 'tcd-w'); ?></span><input type="text" name="dp_options[recent_news_button_font_color_hover]" value="<?php echo esc_attr( $options['recent_news_button_font_color_hover'] ); ?>" data-default-color="#ffffff" class="c-color-picker"></li>
        <li class="cf color_picker_bottom"><span class="label"><?php _e('Background color of button on mouseover', 'tcd-w'); ?></span><input type="text" name="dp_options[recent_news_button_bg_color_hover]" value="<?php echo esc_attr( $options['recent_news_button_bg_color_hover'] ); ?>" data-default-color="#007a96" class="c-color-picker"></li>
       </ul>
      </div>
     </div>
     <ul class="button_list cf">
...
function add_news_theme_options_validate( $input ) {
  ...
  $input['show_news_archive_sidebar'] = ! empty( $input['show_news_archive_sidebar'] ) ? 1 : 0;
  $input['show_news_single_sidebar'] = ! empty( $input['show_news_single_sidebar'] ) ? 1 : 0;

  //ヘッダーの設定
  $input['news_title_direction'] = ! empty( $input['news_title_direction'] ) ? 1 : 0;
  ...
  if ( ! isset( $value['news_sub_title_font_type'] ) )
    $value['news_sub_title_font_type'] = null;
  if ( ! array_key_exists( $value['news_sub_title_font_type'], $font_type_options ) )
    $value['news_sub_title_font_type'] = null;
  ...
  $input['news_sub_title_font_color'] = wp_filter_nohtml_kses( $input['news_sub_title_font_color'] );
  $input['news_sub_title_bg_color'] = wp_filter_nohtml_kses( $input['news_sub_title_bg_color'] );
  ...
  if ( ! isset( $value['archive_news_catch_font_type'] ) )
    $value['archive_news_catch_font_type'] = null;
  if ( ! array_key_exists( $value['archive_news_catch_font_type'], $font_type_options ) )
    $value['archive_news_catch_font_type'] = null;
  $input['archive_news_catch_font_size'] = wp_filter_nohtml_kses( $input['archive_news_catch_font_size'] );
  $input['archive_news_catch_font_size_mobile'] = wp_filter_nohtml_kses( $input['archive_news_catch_font_size_mobile'] );
  ...
  $input['show_recent_news_button'] = ! empty( $input['show_recent_news_button'] ) ? 1 : 0;
  $input['recent_news_button_label'] = wp_filter_nohtml_kses( $input['recent_news_button_label'] );
  $input['recent_news_button_font_color'] = wp_filter_nohtml_kses( $input['recent_news_button_font_color'] );
  $input['recent_news_button_bg_color'] = wp_filter_nohtml_kses( $input['recent_news_button_bg_color'] );
  $input['recent_news_button_font_color_hover'] = wp_filter_nohtml_kses( $input['recent_news_button_font_color_hover'] );
