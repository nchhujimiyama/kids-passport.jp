...
<div id="tab-content-acceleration" class="tab-content">
	<div class="theme_option_field cf theme_option_field_ac open active">
		...
		<div class="theme_option_field_ac_content">
			...
			<div class="theme_option_message2">
				<p><?php _e( 'Check here to remove margins and line breaks in CSS.<br>It also improves the loading speed by generating a page common CSS cache file.<br>* This specification does not apply to custom CSS or external CSS (CDN, etc.).', 'tcd-w' ); ?></p>
			</div>
