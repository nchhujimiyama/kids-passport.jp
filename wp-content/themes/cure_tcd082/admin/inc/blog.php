...
function add_blog_dp_default_options( $dp_default_options ) {
	...
	$dp_default_options['show_blog_archive_sidebar'] = 1;
	$dp_default_options['show_blog_single_sidebar'] = 1;

	// ヘッダー
	$dp_default_options['blog_title_font_type'] = 'type3';
	$dp_default_options['blog_title_font_size'] = '28';
	$dp_default_options['blog_title_font_size_mobile'] = '24';
	$dp_default_options['blog_title_font_color'] = '#FFFFFF';
	$dp_default_options['blog_title_direction'] = '';
	$dp_default_options['blog_sub_title'] = 'BLOG';
	$dp_default_options['blog_sub_title_font_type'] = 'type2';
	$dp_default_options['blog_sub_title_font_size'] = '16';
	$dp_default_options['blog_sub_title_font_size_mobile'] = '14';
	$dp_default_options['blog_sub_title_font_color'] = '#FFFFFF';
	$dp_default_options['blog_sub_title_bg_color'] = '#00a7ce';
...
<div id="tab-content-blog" class="tab-content">
   ...
   <div class="theme_option_field cf theme_option_field_ac">
    ...
    <div class="theme_option_field_ac_content">
     ...
     <ul class="option_list">
      <li class="cf"><span class="label"><?php _e('Display on archive page', 'tcd-w');  ?></span><input name="dp_options[show_blog_archive_sidebar]" type="checkbox" value="1" <?php checked( '1', $options['show_blog_archive_sidebar'] ); ?> /></li>
      <li class="cf"><span class="label"><?php _e('Display on single page', 'tcd-w');  ?></span><input name="dp_options[show_blog_single_sidebar]" type="checkbox" value="1" <?php checked( '1', $options['show_blog_single_sidebar'] ); ?> /></li>
     </ul>
   ...
   <div class="theme_option_field cf theme_option_field_ac">
    ...
    <div class="theme_option_field_ac_content">
     ...
     <ul class="option_list">
      ...
      <li class="cf"><span class="label"><?php _e('Font direction', 'tcd-w'); ?></span><input name="dp_options[blog_title_direction]" type="checkbox" value="1" <?php checked( $options['blog_title_direction'], 1 ); ?>><?php _e( 'Display vertically', 'tcd-w' ); ?></li>
     </ul>
     ...
     <textarea class="full_width" cols="50" rows="2" name="dp_options[blog_sub_title]"><?php echo esc_textarea(  $options['blog_sub_title'] ); ?></textarea>
     <ul class="option_list">
      <li class="cf"><span class="label"><?php _e('Font type', 'tcd-w');  ?></span>
       <select name="dp_options[blog_sub_title_font_type]">
        <?php foreach ( $font_type_options as $option ) { ?>
        <option style="padding-right: 10px;" value="<?php echo esc_attr($option['value']); ?>" <?php selected( $options['blog_sub_title_font_type'], $option['value'] ); ?>><?php echo $option['label']; ?></option>
        <?php } ?>
       </select>
      </li>
      ...
      <li class="cf"><span class="label"><?php _e('Font color', 'tcd-w'); ?></span><input type="text" name="dp_options[blog_sub_title_font_color]" value="<?php echo esc_attr( $options['blog_sub_title_font_color'] ); ?>" data-default-color="#ffffff" class="c-color-picker"></li>
      <li class="cf"><span class="label"><?php _e('Background color', 'tcd-w'); ?></span><input type="text" name="dp_options[blog_sub_title_bg_color]" value="<?php echo esc_attr( $options['blog_sub_title_bg_color'] ); ?>" data-default-color="#00a7ce" class="c-color-picker"></li>
     </ul>
   ...
   <div class="theme_option_field cf theme_option_field_ac">
    ...
    <div class="theme_option_field_ac_content">
     ...
     <ul class="option_list">
      <li class="cf"><span class="label"><?php _e('Font size', 'tcd-w'); ?></span><input class="font_size hankaku" type="text" name="dp_options[archive_blog_desc_font_size]" value="<?php esc_attr_e( $options['archive_blog_desc_font_size'] ); ?>" /><span>px</span></li>
      <li class="cf"><span class="label"><?php _e('Font size (mobile)', 'tcd-w'); ?></span><input class="font_size hankaku" type="text" name="dp_options[archive_blog_desc_font_size_mobile]" value="<?php esc_attr_e( $options['archive_blog_desc_font_size_mobile'] ); ?>" /><span>px</span></li>
     </ul>
...
function add_blog_theme_options_validate( $input ) {
  ...
  $input['show_blog_archive_sidebar'] = ! empty( $input['show_blog_archive_sidebar'] ) ? 1 : 0;
  $input['show_blog_single_sidebar'] = ! empty( $input['show_blog_single_sidebar'] ) ? 1 : 0;

  //ヘッダーの設定
  $input['blog_title_direction'] = ! empty( $input['blog_title_direction'] ) ? 1 : 0;
  ...
  if ( ! isset( $value['blog_sub_title_font_type'] ) )
    $value['blog_sub_title_font_type'] = null;
  if ( ! array_key_exists( $value['blog_sub_title_font_type'], $font_type_options ) )
    $value['blog_sub_title_font_type'] = null;
  ...
  $input['blog_sub_title_font_color'] = wp_filter_nohtml_kses( $input['blog_sub_title_font_color'] );
  $input['blog_sub_title_bg_color'] = wp_filter_nohtml_kses( $input['blog_sub_title_bg_color'] );
