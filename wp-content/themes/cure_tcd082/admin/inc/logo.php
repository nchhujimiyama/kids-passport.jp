   ...
   <div class="theme_option_field cf theme_option_field_ac">
    ...
    <div class="theme_option_field_ac_content">
     ...
     <div class="logo_image_area" style="<?php if( $options['use_logo_image'] == 'yes' ) { echo 'display:block;'; } else { echo 'display:none;'; }; ?>">
      <h4 class="theme_option_headline2"><?php _e('Image for transparent header background', 'tcd-w');  ?></h4>
      <div class="theme_option_message2">
       <p>
        <?php _e('This image will be used when header background is transparent.','tcd-w'); ?>
      ...
      <h4 class="theme_option_headline2"><?php _e('Image for white header background', 'tcd-w');  ?></h4>
      <div class="theme_option_message2">
       <p>
        <?php _e('This image will be used when header background color is white.<br>Alse this image will be used in drawer menu.<br>Please upload same size of image above.','tcd-w'); ?>
       </p>
      </div>
      <div class="image_box cf">
       <div class="cf cf_media_field hide-if-no-js header_logo_image2">
        ...
        <div class="buttton_area">
         <input type="button" value="<?php _e('Select Image', 'tcd-w'); ?>" class="cfmf-select-img button">
         <input type="button" value="<?php _e('Remove Image', 'tcd-w'); ?>" class="cfmf-delete-img button <?php if(!$options['header_logo_image2']){ echo 'hidden'; }; ?>">
        </div>
       </div>
      </div>
     </div>
     ...
     <div class="logo_image_area" style="<?php if( $options['use_logo_image_mobile'] == 'yes' ) { echo 'display:block;'; } else { echo 'display:none;'; }; ?>">
      ...
      <div class="image_box cf">
       <div class="cf cf_media_field hide-if-no-js header_logo_image_mobile2">
        ...
        <div class="buttton_area">
         <input type="button" value="<?php _e('Select Image', 'tcd-w'); ?>" class="cfmf-select-img button">
         <input type="button" value="<?php _e('Remove Image', 'tcd-w'); ?>" class="cfmf-delete-img button <?php if(!$options['header_logo_image_mobile2']){ echo 'hidden'; }; ?>">
        </div>
       </div>
      </div>
     </div>
   ...
   <div class="theme_option_field cf theme_option_field_ac">
    ...
    <div class="theme_option_field_ac_content">
     ...
     <ul class="design_radio_button select_logo_type">
      <?php foreach ( $logo_type_options as $option ) { ?>
      <li>
       <input type="radio" class="use_logo_image_<?php esc_attr_e( $option['value'] ); ?>" id="use_logo_image_footer_<?php esc_attr_e( $option['value'] ); ?>" name="dp_options[use_logo_image_footer]" value="<?php esc_attr_e( $option['value'] ); ?>" <?php checked( $options['use_logo_image_footer'], $option['value'] ); ?> />
       <label for="use_logo_image_footer_<?php esc_attr_e( $option['value'] ); ?>"><?php echo $option['label']; ?></label>
      </li>
      <?php } ?>
     </ul>
     <div class="logo_text_area" style="<?php if( $options['use_logo_image_footer'] != 'yes' ) { echo 'display:block;'; } else { echo 'display:none;'; }; ?>">
      <h4 class="theme_option_headline2"><?php _e('Font size setting', 'tcd-w');  ?></h4>
     ...
     <div class="logo_image_area" style="<?php if( $options['use_logo_image_footer'] == 'yes' ) { echo 'display:block;'; } else { echo 'display:none;'; }; ?>">
   ...
   <div class="theme_option_field cf theme_option_field_ac">
    ...
    <div class="theme_option_field_ac_content">
     ...
     <ul class="design_radio_button select_logo_type">
      <?php foreach ( $logo_type_options as $option ) { ?>
      <li>
       <input type="radio" class="use_logo_image_<?php esc_attr_e( $option['value'] ); ?>" id="use_logo_image_footer_mobile_<?php esc_attr_e( $option['value'] ); ?>" name="dp_options[use_logo_image_footer_mobile]" value="<?php esc_attr_e( $option['value'] ); ?>" <?php checked( $options['use_logo_image_footer_mobile'], $option['value'] ); ?> />
       <label for="use_logo_image_footer_mobile_<?php esc_attr_e( $option['value'] ); ?>"><?php echo $option['label']; ?></label>
      </li>
      <?php } ?>
     </ul>
     <div class="logo_text_area" style="<?php if( $options['use_logo_image_footer_mobile'] != 'yes' ) { echo 'display:block;'; } else { echo 'display:none;'; }; ?>">
      <h4 class="theme_option_headline2"><?php _e('Font size setting', 'tcd-w');  ?></h4>
     ...
     <div class="logo_image_area" style="<?php if( $options['use_logo_image_footer_mobile'] == 'yes' ) { echo 'display:block;'; } else { echo 'display:none;'; }; ?>">
      <h4 class="theme_option_headline2"><?php _e('Image', 'tcd-w');  ?></h4>
      <div class="theme_option_message2">
       <p>
        <?php printf(__('Maximum height is %s. We recommend to use the background transparent PNG image.', 'tcd-w'), '50'); ?><br />
