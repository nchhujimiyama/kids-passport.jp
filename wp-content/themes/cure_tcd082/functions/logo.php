...
function header_logo(){
  ...
  $logo_image_mobile2 = wp_get_attachment_image_src( $options['header_logo_image_mobile2'], 'full' );
...
<h2 class="logo">
 <a href="<?php echo esc_url($url); ?>/" title="<?php echo esc_attr($title); ?>">
  ...
  <img class="pc_logo_image <?php if($logo_image2){ echo 'type1'; }; ?>" src="<?php echo esc_attr($logo_image[0]); ?>?<?php echo esc_attr(time()); ?>" alt="<?php echo esc_attr($title); ?>" title="<?php echo esc_attr($title); ?>" width="<?php echo esc_attr($pc_image_width); ?>" height="<?php echo esc_attr($pc_image_height); ?>" />
  <?php if($logo_image2){ ?><img class="pc_logo_image type2" src="<?php echo esc_attr($logo_image2[0]); ?>?<?php echo esc_attr(time()); ?>" alt="<?php echo esc_attr($title); ?>" title="<?php echo esc_attr($title); ?>" width="<?php echo esc_attr($pc_image_width2); ?>" height="<?php echo esc_attr($pc_image_height2); ?>" /><?php }; ?>
  <?php } else { ?>
  ...
  <?php if($logo_image_mobile2){ ?><img class="mobile_logo_image type2" src="<?php echo esc_attr($logo_image_mobile2[0]); ?>?<?php echo esc_attr(time()); ?>" alt="<?php echo esc_attr($title); ?>" title="<?php echo esc_attr($title); ?>" width="<?php echo esc_attr($mobile_image_width2); ?>" height="<?php echo esc_attr($mobile_image_height2); ?>" /><?php }; ?>
  <?php } else { ?>
