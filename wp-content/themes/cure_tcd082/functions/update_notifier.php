...
?>
    ...
    <div class="wrap">
     	...
     	<div id="mono_instructions">
            ...
            <p style="font-size:16px;">【 <a href="https://tcd.plus/dl082/cure/cure_tcd082.zip"><?php _e( 'Download the latest version', 'tcd-w' ); ?></a> 】</p>
     		<div id="mono_info">
...
function get_latest_theme_version( $interval ) {
    ...
    $notifier_file_url = 'http://design-plus1.com/notifier_cure.xml';
    $db_cache_field = 'cure-contempo-notifier-cache';
    $db_cache_field_last_updated = 'cure-contempo-notifier-last-updated';
