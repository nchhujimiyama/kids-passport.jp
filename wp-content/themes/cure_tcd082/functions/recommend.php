...
<ul>
 ...
 <li><label><input type="checkbox" name="featured_post" value="on" <?php if( $featured_post == 'on' ) { ?>checked="checked"<?php } ?> />  <?php _e('Show this post for pickup post', 'tcd-w');  ?></label></li>
</ul>
<?php
}
