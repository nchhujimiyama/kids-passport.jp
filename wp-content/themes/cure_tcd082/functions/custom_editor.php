...
<?php
	for ( $i = 1; $i <= 5; $i++ ) {
		echo '.q_custom_button' . $i . ', .editor-styles-wrapper .q_custom_button' . $i . ' { background: ' . esc_attr( $dp_options['qt_custom_button_bg_color' . $i] ) . ' !important; color: ' . esc_attr( $dp_options['qt_custom_button_font_color' . $i] ) . ' !important; border-color: ' . esc_attr( $dp_options['qt_custom_button_border_color' . $i] ) . ' !important; }' . "\n";
		echo '.q_custom_button' . $i . ':hover, .q_custom_button' . $i . ':focus, .editor-styles-wrapper .q_custom_button' . $i . ':hover, .editor-styles-wrapper .q_custom_button' . $i . ':focus { background: ' . esc_attr( $dp_options['qt_custom_button_bg_color_hover' . $i] ) . ' !important; color: ' . esc_attr( $dp_options['qt_custom_button_font_color_hover' . $i] ) . ' !important; border-color: ' . esc_attr( $dp_options['qt_custom_button_border_color_hover' . $i] ) . ' !important; }' . "\n";
	}
