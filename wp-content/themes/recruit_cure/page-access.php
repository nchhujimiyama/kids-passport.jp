   ...
   <div class="access_google_map">
    ...
    jQuery(function($) {
      $(window).load(function() {
        initMap('dc_google_map<?php echo esc_attr($key); ?>', '<?php echo esc_js( $address ); ?>', <?php echo esc_js( $access_saturation ); ?>, <?php echo esc_js( $use_custom_overlay ); ?>, '<?php if( $options['basic_gmap_custom_marker_type'] == 'type2' ) { echo esc_js( $marker_img ); }; ?>', '<?php echo esc_js( $marker_text ); ?>');
      });
    });
    </script>
