...
// カテゴリー編集用入力欄を出力 -------------------------------------------------------
function edit_child_category_custom_fields( $term ) {
	$term_meta = get_option( 'taxonomy_' . $term->term_id, array() );
	$term_meta = array_merge( array(
		'category_font_color' => '#ffffff',
		'category_bg_color' => '#02a8c6',
		'category_font_color_hover' => '#ffffff',
		'category_bg_color_hover' => '#007a96',
		'image' => null,
		'use_overlay' => '',
 ...
 <div class="ccm_content clearfix">
  ...
  <div class="input_field">
   <ul class="option_list">
    <li class="cf"><span class="label"><?php _e('Font color', 'tcd-w'); ?></span><input type="text" name="term_meta[category_font_color]" value="<?php echo esc_attr( $term_meta['category_font_color'] ); ?>" data-default-color="#ffffff" class="c-color-picker"></li>
    <li class="cf"><span class="label"><?php _e('Background color', 'tcd-w'); ?></span><input type="text" name="term_meta[category_bg_color]" value="<?php echo esc_attr( $term_meta['category_bg_color'] ); ?>" data-default-color="#02a8c6" class="c-color-picker"></li>
    <li class="cf"><span class="label"><?php _e('Font color on mouseover', 'tcd-w'); ?></span><input type="text" name="term_meta[category_font_color_hover]" value="<?php echo esc_attr( $term_meta['category_font_color_hover'] ); ?>" data-default-color="#ffffff" class="c-color-picker"></li>
    <li class="cf"><span class="label"><?php _e('Background color on mouseover', 'tcd-w'); ?></span><input type="text" name="term_meta[category_bg_color_hover]" value="<?php echo esc_attr( $term_meta['category_bg_color_hover'] ); ?>" data-default-color="#007a96" class="c-color-picker"></li>
   </ul>
  </div><!-- END input_field -->
 </div><!-- END ccm_content -->
...
add_action( 'diary_category_edit_form_fields', 'edit_child_category_custom_fields' );



// データを保存 -------------------------------------------------------
function save_child_category_custom_fields( $term_id ) {
  $new_meta = array();
...
add_action( 'edited_terms', 'save_child_category_custom_fields' );
