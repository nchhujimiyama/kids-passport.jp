<?php
function child_blog_meta_box() {
  $post_types = array ( 'menu', 'diary' );
  add_meta_box(
    'blog_meta_box',//ID of meta box
    __('Other options', 'tcd-w'),//label
    'show_child_blog_meta_box',//callback function
    $post_types,// post type
    'normal',// context
    'high'// priority
  );
}
add_action('add_meta_boxes', 'child_blog_meta_box');

function show_child_blog_meta_box() {
...
function save_child_blog_meta_box( $post_id ) {
...
add_action('save_post', 'save_child_blog_meta_box');
