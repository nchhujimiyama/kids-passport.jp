...
function child_custom_css_meta_box() {
  $post_types = array ( 'menu', 'diary' );
  add_meta_box(
    'custom_css',//ID of meta box
    __('Custom CSS for this page', 'tcd-w'),//label
    'show_child_custom_css_meta_box',//callback function
    $post_types,// post type
    'normal',// context
    'low'// priority
  );
}
add_action('add_meta_boxes', 'child_custom_css_meta_box', 999);

function show_child_custom_css_meta_box() {
    global $post;
...
function save_child_custom_css_meta_box( $post_id ) {
...
add_action('save_post', 'save_child_custom_css_meta_box');
