<?php
     ...
     $title = $options['menu_label'];
     $title_font_type = $options['menu_title_font_type'];
     $title_direction = $options['menu_title_direction'];
     $sub_title = $options['menu_sub_title'];
     $sub_title_font_type = $options['menu_sub_title_font_type'];
     ...
     if($use_overlay) {
       $overlay_color = $options['menu_overlay_color'];
...
<div id="main_contents" class="clearfix">
  ...
  <?php if($options['archive_menu_headline'] || $options['archive_menu_catch'] || $options['archive_menu_desc']) { ?>
  <div id="content_header">
   <?php if(!empty($options['archive_menu_headline'])) { ?>
   <h2 class="headline rich_font_<?php echo esc_attr($options['archive_menu_headline_font_type']); ?>"><?php echo esc_html($options['archive_menu_headline']); ?></h2>
   <?php }; ?>
   <?php if(!empty($options['archive_menu_catch'])) { ?>
   <h3 class="catch rich_font_<?php echo esc_attr($options['archive_menu_catch_font_type']); ?>"><?php echo esc_html($options['archive_menu_catch']); ?></h3>
   <?php }; ?>
   <?php if(!empty($options['archive_menu_desc'])) { ?>
   <p class="desc"><?php echo wp_kses_post(nl2br($options['archive_menu_desc'])); ?></p>
   <?php }; ?>
  </div>
  <?php }; ?>
 ...
 <div id="main_col">
    ...
    <a class="link animate_background" href="<?php the_permalink(); ?>">
     ...
     <div class="title_area">
      <div class="title_area_inner">
       <?php if ( $options['archive_menu_show_date'] ){ ?>
  ...
  <?php if($options['archive_menu_layout'] != 'type3') { get_sidebar(); }; ?>
